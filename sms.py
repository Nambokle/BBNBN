...
def home():
	print(f'''
    {Fore.RED}IKGA-SOURCE Pro 120 API + 11 Call !!
    {Fore.GREEN}[+] โปรแกรมยิงเบอร์ : พร้อมใช้งาน! 🟢
  	{Fore.BLUE}https://discord.gg/ikgas''')
	phone = input("เบอร์ที่จะยิง  :")
	
	if int(phone) <= 99999999 or int(phone) >= 999999999:
		print()
		print('\x1b[92m[ เกิดข้อผิดพลาด]\x1b[00m : \x1b[91mคุณใส่เบอร์ไม่ถูกต้อง [ ! ] \x1b[00m')
		time.sleep(2)
		exit(12000)
	else:
		phone = phone
		jam = int(input("\x1b[96m จำนวนการยิง : \x1b[92m"))
		jam = jam
		print()
		print()
		SMS(phone, jam)
...
def api1(phone):
	...
	if sms.status_code == 200 or sms.status_code == 201:
		print(f"\x1b[31m[\x1b[00m{ok}\x1b[31m] \x1b[00m: \x1b[32mยิงสำเร็จ | {sms.status_code}")
	else:
		print(f"\x1b[31m[\x1b[00m{ok}\x1b[31m] \x1b[00m: \x1b[31mFalse   | {sms.status_code}")
...
def api2(phone):
	...
	if r.status_code == 200 or r.status_code == 201:
		print(f"\x1b[31m[\x1b[00m{ok}\x1b[31m] \x1b[00m: \x1b[32mยิงสำเร็จ | {r.status_code}")
	else:
		print(f"\x1b[31m[\x1b[00m{ok}\x1b[31m] \x1b[00m: \x1b[31mFalse   | {r.status_code}")
